...
<section class="py-5">
	<div class="container">
		...
		<table class="table table-bordered table-hover" cellpadding="2px">
			...
			<?php
				$obj = new Config();
				$obj->select('employee', '*', 'employeeclass', 'employee.cid = employeeclass.cid', 5);
			...
			?>
					<tr>
						...
						<td style="text-align: center;">
							...
							<a role="button" href='delete-inline.php?id=<?php echo $v['id']; ?>'><i class="bi bi-trash px-2" style="font-size: 1.2rem; color: #df4759;"></i></a>
						</td>
					</tr>
			<?php
				} 
		...
		<nav aria-label="Page navigation example">
			...
			<?php
				...
				$total_page = $obj->pagination('employee', 'employeeclass', 'employee.cid = employeeclass.cid', 5);
				 
				for ($i = 1; $i <= $total_page; $i++)
				{
					$cls = "";
					if(isset($_GET['page'])){
						if($i == $_GET['page']){$cls = "active";}
					}
